...
var domFor = __webpack_require__(/*! ./render/domFor */ "./node_modules/mithril/render/domFor.js");
var m = function m() {
...
var Vnode = __webpack_require__(/*! ../render/vnode */ "./node_modules/mithril/render/vnode.js");
var df = __webpack_require__(/*! ../render/domFor */ "./node_modules/mithril/render/domFor.js");
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
...
class SettingsPage extends (flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_0___default()) {
  content(vnode) {
    console.info("this.extension.id", this.extension.id);
    const settings = flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().registry.getSettings(this.extension.id);
    const flarumSettings = this.flarumClientSettings(1);
    return mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "ExtensionPage-settings"
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "container"
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form"
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      ...
      type: 'checkbox',
      label: 'Provider mode',
      setting: 'abdulrehman-sso.provider_mode',
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.provider_mode'),
      className: 'abdulrehman-sso--provider-mode'
    }), mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      hidden: !this.booleanSetting('provider_mode')
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form-group"
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("table", null, mithril__WEBPACK_IMPORTED_MODULE_2___default()("thead", null, mithril__WEBPACK_IMPORTED_MODULE_2___default()("tr", null, flarumSettings.map(setting => mithril__WEBPACK_IMPORTED_MODULE_2___default()("th", {
      key: setting.setting
    }, setting.label, mithril__WEBPACK_IMPORTED_MODULE_2___default()("br", null), mithril__WEBPACK_IMPORTED_MODULE_2___default()("span", {
      className: "helpText",
      style: {
        fontWeight: 'normal'
      }
    }, setting.help))))), mithril__WEBPACK_IMPORTED_MODULE_2___default()("tbody", null, this.clientRows()))), mithril__WEBPACK_IMPORTED_MODULE_2___default()((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default()), {
      className: "Button",
      "aria-label": "Add instance",
      icon: "fa fa-plus",
      onclick: this.addRow.bind(this)
    }, "Add Flarum instance"))), mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form-group",
      hidden: this.booleanSetting('provider_mode')
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("hr", null), mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form-group"
    }, this.generalClientSettings().map(this.buildSettingComponent.bind(this))), settings?.map(this.buildSettingComponent.bind(this)), mithril__WEBPACK_IMPORTED_MODULE_2___default()("hr", null), mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form-group"
    }, mithril__WEBPACK_IMPORTED_MODULE_2___default()("h4", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.jwt_section_subtitle')), this.jwtSettings().map(this.buildSettingComponent.bind(this)))), mithril__WEBPACK_IMPORTED_MODULE_2___default()("div", {
      className: "Form-group"
    }, this.submitButton()))));
  }
  oncreate(vnode) {
    super.oncreate(vnode);
    this.setting('abdulrehman-sso.provider_mode').map(() => mithril__WEBPACK_IMPORTED_MODULE_2___default().redraw());
  }
  addRow() {
    const next = this.clientRows().length + 1;
    (flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().data).settings[`abdulrehman-sso.client${next}_url`] = '';
  }
  clientRows() {
    const clientRows = [];
    let i = 1;
    while (`abdulrehman-sso.client${i}_url` in (flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().data).settings) {
      clientRows.push(mithril__WEBPACK_IMPORTED_MODULE_2___default()("tr", {
        key: `client${i}`
      }, this.flarumClientSettings(i).map(setting => {
        setting.label = undefined;
        setting.help = undefined;
        return mithril__WEBPACK_IMPORTED_MODULE_2___default()("td", {
          key: setting.setting
  ...
  flarumClientSettings(clientNumber) {
    return [{
      setting: `abdulrehman-sso.client${clientNumber}_name`,
      type: 'text',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_name'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_name_help')
    }, {
      setting: `abdulrehman-sso.client${clientNumber}_url`,
      type: 'text',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_url'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_url_help')
    }, {
      setting: `abdulrehman-sso.client${clientNumber}_api_key`,
      type: 'password',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_api_key'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_api_key_help')
    }, {
      setting: `abdulrehman-sso.client${clientNumber}_password_token`,
      type: 'password',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_password_token'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_password_token_help')
    }, {
      setting: `abdulrehman-sso.client${clientNumber}_verify_ssl`,
      type: 'checkbox',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_verify_ssl'),
      help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.client_verify_ssl_help')
    }];
  }
  generalClientSettings() {
    return [{
      setting: 'abdulrehman-sso.login_url',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.login_url'),
      type: 'url'
    }, {
      setting: 'abdulrehman-sso.signup_url',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.signup_url'),
      type: 'url'
    }, {
      setting: 'abdulrehman-sso.logout_url',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.logout_url'),
      type: 'url'
    }, {
      setting: 'abdulrehman-sso.manage_account_url',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.manage_account_url'),
      type: 'url'
    }, {
      setting: 'abdulrehman-sso.cookies_prefix',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.cookies_prefix'),
      type: 'text'
    }];
  }
  jwtSettings() {
    return [{
      setting: 'abdulrehman-sso.jwt_iss',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.jwt_iss'),
      type: 'text'
    }, {
      setting: 'abdulrehman-sso.jwt_signing_algorithm',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.jwt_signing_algorithm'),
      type: 'select',
      options: {
        Sha256: 'Sha256',
        Sha384: 'Sha384',
      ...
      setting: 'abdulrehman-sso.jwt_signer_key',
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('abdulrehman-sso.admin.settings.jwt_signer_key'),
      type: 'text'
    }];
  }
  booleanSetting(setting) {
    return Boolean(Number(this.setting(`abdulrehman-sso.${setting}`)()));
  }
}
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('abdulrehman-sso', () => {
  console.info('ADMIN: App is initialized abdulrehman-sso!!!!!');
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().registry.for('abdulrehman-sso').registerSetting({
    setting: 'abdulrehman-sso.manage_account_btn_open_in_new_tab',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('abdulrehman-sso.admin.settings.manage_account_btn_open_in_new_tab'),
    type: 'boolean'
  }).registerSetting({
    setting: 'abdulrehman-sso.remove_login_btn',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('abdulrehman-sso.admin.settings.remove_login_btn'),
    type: 'boolean'
  }).registerSetting({
    setting: 'abdulrehman-sso.remove_signup_btn',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('abdulrehman-sso.admin.settings.remove_signup_btn'),
    type: 'boolean'
  }).registerPage(_SettingsPage__WEBPACK_IMPORTED_MODULE_1__.SettingsPage);
});
